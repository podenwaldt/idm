"""
Configuration and hyperparameters for the Inverse Dynamics Model V2.
This version uses MobileNetV2 architecture and 4 stacked frames.
"""
...
class IDMConfig:
    ...
    # MobileNetV2 specific settings
    mobilenet_width_mult: float = 1.0  # Width multiplier for MobileNetV2 (0.5, 0.75, 1.0, 1.25, 1.5, 2.0)
    mobilenet_pretrained: bool = True  # Use ImageNet pretrained weights
    ...
    checkpoint_dir: str = "checkpoints_v2"  # Separate checkpoint directory for v2
